...
async def test_migration_created_every_table_and_nothing_else(
    ...
    # Exactly the F1 identity tables, the S1 snapshot tables, the F4 paper
    # watchlist, the issue #15 read-through cache and B10's manual fixed
    # deposits, plus alembic's bookkeeping — no speculative tables. Extending
