...
async def test_migration_created_every_table_and_nothing_else(
    ...
    # watchlist and the issue #15 read-through cache, plus alembic's
    # bookkeeping — no speculative tables. Extending this set is a deliberate
    # act, which is the point: a stray autogenerated table fails here first.
    assert names == {
        "users",
        "broker_links",
        "oauth_pending",
