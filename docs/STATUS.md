...
**Last updated:** 2026-08-16 (F3 built on `v2-foundation` — the auth singleton is dead, links are per-user and encrypted, F2's three latent Importants closed; awaiting review. Operator: four env vars + a real IND Money login, `docs/TESTING/F3.md` §6)
