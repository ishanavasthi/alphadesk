...
**Last updated:** 2026-08-16 (F2 built on `v2-foundation` — Clerk behind an off-by-default flag, live site pixel-verified unchanged; awaiting review + merge)
