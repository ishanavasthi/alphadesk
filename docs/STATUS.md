...
**Last updated:** 2026-08-15 (C2 merged to `main` after 2 fix rounds + independent audit; **human gate open** — a human must read `docs/ind_money_payloads.md`'s go/no-go before M1 starts)
