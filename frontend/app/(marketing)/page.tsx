...
export const metadata: Metadata = {
  title: "AlphaDesk: your whole net worth, verified then narrated",
  description:
    "AlphaDesk links your IND Money account read-only and shows net worth, allocation, holdings and daily history, narrated from numbers computed in Python. Descriptive analytics only; not investment advice.",
};
